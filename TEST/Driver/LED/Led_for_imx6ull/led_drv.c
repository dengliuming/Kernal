...
static int __init led_init(void)
{
	...
	for(i = 0; i < gptr_led_op->number; i++)
	{
		device_create(led_class, NULL, MKDEV(major, i), NULL, "led_A_%d", i); /* /dev/led_A */	//MKDEV(major, i)  : 主设备号 次设备号
	}
	
	gptr_led_op = GetBordLedOperations();
