...
GCNANO_BINARIES_LIB_VERSION = 6.4.1
GCNANO_BINARIES_LIBUSER_VERSION = 6.4
GCNANO_BINARIES_VERSION = eaff2c61bcc3936f8193a52ffe965bdcc6457a57
GCNANO_BINARIES_DRIVER_VERSION = $(GCNANO_BINARIES_LIB_VERSION)
GCNANO_BINARIES_USERLAND_VERSION = $(GCNANO_BINARIES_LIB_VERSION)-20200402
...
define GCNANO_BINARIES_INSTALL
	$(foreach lib,$(GCNANO_BINARIES_LIBRARIES), \
		$(INSTALL) -D -m 0755 $(@D)/$(GCNANO_BINARIES_USERLAND_SUBDIR)/usr/lib/$(lib).$(GCNANO_BINARIES_LIBUSER_VERSION).multi.release.so \
			$(1)/usr/lib/$(lib).$(GCNANO_BINARIES_LIBUSER_VERSION).multi.release.so ; \
